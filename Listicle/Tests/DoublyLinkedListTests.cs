...
{
    class DoublyLinkedListTests : TestBase
    {
        public DoublyLinkedListTests()
        {
            Console.WriteLine("DoublyLinkedListTests");
            Console.WriteLine("=====================");
            Console.WriteLine();
        }
        public bool AddTest()
        {
            Console.WriteLine("DoublyLinkedListTests : AddTest");
            var result = true;
        ...
        {
            Console.WriteLine("DoublyLinkedListTests : ValuesTest");
            var result = true;
